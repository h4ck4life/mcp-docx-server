...
from tools.document_core import register_document_core_tools
from tools.document_content import register_document_content_tools
from tools.document_style import register_document_style_tools
from tools.document_table import register_document_table_tools
from tools.document_section import register_document_section_tools
from tools.document_headers import register_document_headers_tools
from tools.document_utilities import register_document_utility_tools
...
register_document_core_tools(mcp)
register_document_content_tools(mcp)
register_document_style_tools(mcp)
register_document_table_tools(mcp)
register_document_section_tools(mcp)
register_document_headers_tools(mcp)
register_document_utility_tools(mcp)
